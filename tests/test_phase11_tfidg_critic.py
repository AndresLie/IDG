    ...
    rows = [
        {
            ...
            "generation_mask_path": str(inpaint_mask_path),
            "generation_mask_variant": "inpaint_soft",
            "generation_mask_role": "generation",
            "benchmark_eval_mask_path": str(refined_mask_path),
            "generation_seed": 0,
...
""",
    ...
    assert by_name["good.png"]["generation_mask_variant"] == "inpaint_soft"
    assert by_name["good.png"]["generation_mask_role"] == "generation"
    assert by_name["good.png"]["generation_mask_path"] == str(inpaint_mask_path)
