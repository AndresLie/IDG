...
PPTX: `/home/p76147019/ImgGen/v2/reports/presentations/final_pipeline_result/current_pipeline_final_result_report.pptx`
Evidence snapshot: `/home/p76147019/ImgGen/v2/reports/presentations/final_pipeline_result/current_pipeline_final_result_data.json`

## Slide Outline

1. Automatic industrial defect pseudo-mask pipeline
2. Executive conclusion
3. Why automatic pseudo-masks matter
4. Research questions and claim boundaries
5. End-to-end research pipeline
6. Automatic mask generation core
7. One defect, multiple mask roles
...
- Cache hit: `True`
- Elapsed seconds: `2072.772`
- Macro selected Dice: `0.366449`
- Macro oracle Dice: `0.502032`
- Candidate count: `32244`
