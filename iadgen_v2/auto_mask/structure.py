...
def infer_structure_profile(category: str, defect_type: str, description: str = "") -> str:
    """Map semantic text to a geometry profile used by optional specialists.

    Product and defect names remain inputs for compatibility, but the returned
    contract is category-independent. Future Qwen attribute output can replace
    these text cues without changing proposal implementations.
    """
